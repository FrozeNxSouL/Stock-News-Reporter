...
.ticker-bubble {
  ...
  border: 1.5px solid rgba(243, 228, 201, 0.35);
...
.ticker-bubble:hover {
  background: rgba(243, 228, 201, 0.18);
  border-color: rgba(243, 228, 201, 0.60);
  color: #FAF4EA;
}

.ticker-bubble.active {
  background: rgba(243, 228, 201, 0.25);
  border-color: rgba(243, 228, 201, 0.80);
  color: #FAF4EA;
  box-shadow: 0 0 12px rgba(243, 228, 201, 0.15);
}
...
.price-card.price-down {
  ...
  border-color: rgba(181, 50, 48, 0.20);
}

.price-card.price-neutral {
  background: var(--grad-neutral);
}

.price-card:hover {
  transform: translateY(-4px);
  box-shadow: 0 20px 48px rgba(107, 63, 31, 0.20), 0 6px 16px rgba(107, 63, 31, 0.10);
}

html.dark .price-card:hover {
  box-shadow: 0 20px 48px rgba(0,0,0,0.50), 0 6px 16px rgba(0,0,0,0.30);
}
...
.card-bg-orb {
  ...
  height: 90px;
  border-radius: 50%;
  background: rgba(243, 228, 201, 0.10);
  pointer-events: none;
}
...
.card-change.price-up { color: var(--up-color); }
.card-change.price-down { color: var(--down-color); }
.card-change.price-neutral { color: var(--neutral-color); }
